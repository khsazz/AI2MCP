...
\begin{tabular}{lccc}
\toprule
\textbf{Metric} & \textbf{Kinematic-GNN} & \textbf{Multimodal-GNN} & \textbf{Winner} \\
\midrule
Micro Accuracy & \textbf{97.03\%} & 96.51\% & Kinematic \\
Macro F1 Score & \textbf{0.358} & 0.348 & Kinematic \\
Inference Latency & \textbf{1.52ms} & 24.29ms & Kinematic ($16\times$) \\
Peak Memory (MB) & \textbf{19.4} & 141.8 & Kinematic ($7\times$) \\
Model Size (MB) & \textbf{0.81} & 2.14 & Kinematic \\
\bottomrule
\end{tabular}
\end{table}
