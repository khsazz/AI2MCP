...
We classify LLM-robot integrations into three paradigms: \textit{End-to-End} (e.g., RT-2), \textit{Code-as-Policies}, and our proposed \textit{Protocol-Driven} approach. Table~\ref{tab:comparison} situates AI2MCP within this landscape.
...
\begin{tabular}{lcccc}
\toprule
\textbf{System} & \textbf{Protocol} & \textbf{Safety Verification} & \textbf{Hot-swappability} & \textbf{Reasoning} \\
\midrule
SayCan \cite{saycan2022} & Proprietary & Affordance-based & Low & Language \\
RT-2 \cite{rt22023} & None & Probabilistic & None & Multimodal \\
\textbf{AI2MCP (Ours)} & \textbf{MCP (Std.)} & \textbf{Sim-Verification} & \textbf{High} & \textbf{Kinematic GNN} \\
\bottomrule
\end{tabular}}
\end{table}
